...
## Books/Livros
 - [Quarkus in Action by Martin Štefanko and Jan Martiška - Manningm  Fall 2023 (estimated)](https://www.manning.com/books/quarkus-in-action)
...
# Videos
 ...
 - [+inspiração praTi | Episódio 8: Como fazer boas conversões de DTOs em Java, by Nataniel Paiva, AUG, 2023](https://www.youtube.com/watch?v=ccAnyk4ngmc)
...
- [JWT verification against Amazon Cognito as an IdP Service using the Quarkus Framework, by Andres Solorzano, Aug, 2022](https://aosolorzano.medium.com/jwt-verification-against-amazon-cognito-using-java-quarkus-55f3d22456ae) 
 ...
 - [Implementing Microservicilities with Quarkus and MicroProfile, InfoQ, by Alex Soto and Michael Redlich, May, 2021](https://www.infoq.com/articles/microservicilities-quarkus/) 
